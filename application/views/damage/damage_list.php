                ...
                <div class="content">
                    ...
                    <div class="panel panel-flat">
                        <div class="panel-heading">
                            <a class="btn btn-sm btn-success" href="<?php echo base_url()?>Product/damageProductForm"><i class="icon-home4"></i> Add Damage Product</a>
                        </div>

                        <table class="table" id="damage-list">
                            <thead>
                                <tr>
                                    <th>Sr. No.</th>
                                    <th>Total</th>
                            ...
                            <tbody>
                                ...
                                ?>
                                    ...
                                    <td><a href="<?php base_url()?>damageDetails/<?php echo $row['damage_id'] ?>" class="btn btn-sm btn-success">View Details</a></td>
                                        ...
                                        <ul class="icons-list">
                                            <li class="dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                    <li><a href="<?php echo base_url() ?>Product/editDamage/<?php echo $row['damage_id'] ?>"><i class="icon-file-pdf"></i> Edit</a></li>
                                                    <li><a href="#" id="<?php echo $row['damage_id']?>" class="delete" data-url="<?php echo base_url()?>Product/deleteDamage/<?php echo $row['damage_id']?>"><i class="icon-file-excel"></i> Delete</a></li>
                                                </ul>
                                            </li>
                                        </ul>
                                    </td>                                   
