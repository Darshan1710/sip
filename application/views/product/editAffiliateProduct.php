          ...
          <div class="row">
            <div class="col-md-12">
              <div class="panel panel-flat">
                ...
                <input type="hidden" name="id" class="id" value="<?php echo set_value('id',isset($product['id']) ? $product['id'] : '')?>" id="id">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-sm-6">
                                <label>Link</label>
                                <input type="text" placeholder="Link" class="form-control link" name="link" value="<?php echo set_value('link',isset($product['link']) ? $product['link'] : '')?>">
                            </div>
                            <div class="col-sm-6">
                                <label>Status</label>
                                <select class="form-control select status" name="status">
                                    ...
                                    <option value="2" <?php echo set_select('status', '1', $product['status'] == '2' ? TRUE : FALSE ); ?>>Inactive</option>
                                </select>
                            </div>
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <textarea class="form-control description" name="description"><?php echo $short_description = empty($product['description']) ? set_value('description') : $product['description']?></textarea>
                            </div>
...
<script type="text/javascript">
        $('#update').submit(function(e) {
            ...
            $.ajax({
                ...
                processData: false,
                contentType: false,
                url: base_url + 'Product/updateAffiliateProduct/'+id,
