                ...
                <div class="content">
                    ...
                    <div class="panel panel-flat">
                        <div class="panel-heading">
                            ...
                            <a class="btn btn-sm btn-danger delete_all" href="#" data-table="<?php echo $this->encryption->encrypt('categories'); ?>" data-type="active"><i class="icon-box-add"></i> Active</a>
                            <a class="btn btn-sm btn-danger delete_all" href="#" data-table="<?php echo $this->encryption->encrypt('categories'); ?>" data-type="inactive"><i class="icon-bin"></i> Inactive</a>
                        ...
                        <table class="table" id="category_list">
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                    <td><input type="checkbox" class="check" value="<?php echo $row['id'] ?>"></td>
                                    <td><?php echo $i; ?></td>
                                        ...
                                        <ul class="icons-list">
                                            <li class="dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                    ...
                                                    <li><a href="#" id="<?php echo $row['id']?>" class="delete"  data-table="<?php echo $this->encryption->encrypt('categories')?>"><i class="icon-file-excel"></i> Delete</a></li>
                                                </ul>
                                            </li>
                                        </ul>
                                    </td>
