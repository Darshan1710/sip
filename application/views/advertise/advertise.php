                ...
                <div class="content">
                    ...
                    <div class="panel panel-flat">
                        <div class="panel-heading">
                            <a class="btn btn-sm btn-success" href="#" data-target="#add_modal" data-toggle="modal"><i class="icon-home4"></i> Add Advertise</a>
                        </div>


                        <table class="table" id="advertise_list">
                            <thead>
                                <tr>
                                    <th>Sr. No.</th>
                                    <th>Name</th>
                                        ...
                                        <ul class="icons-list">
                                            <li class="dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                    <li><a href="#" id="<?php echo $row['id'] ?>" data-toggle="modal" data-target="#edit_modal" class="editAdvertise"><i class="icon-file-pdf"></i> Edit</a></li>
                                                    <li><a href="#" id="<?php echo $row['id']?>" class="delete" data-url="<?php echo base_url()?>Advertise/deleteAdvertise/<?php echo $row['id']?>" data-table="<?php echo $this->encryption->encrypt('advertise') ?>"><i class="icon-file-excel" ></i> Delete</a></li>
                                                </ul>
                                            </li>
                                        </ul>
                                    </td>
    ...
    <div class="modal-dialog ">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h5 class="modal-title">Advertise form</h5>
            </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var table = $('#advertise_list').DataTable({
            "order": [],
        ...
        $('#add').submit(function(e) {
            ...
            $.ajax({
                ...
                processData: false,
                contentType: false,
                url: base_url + 'Advertise/addAdvertise',
        ...
        $(document).on('click', '.editAdvertise', function() {
            ...
            $.ajax({
                ...
                url: base_url + 'Advertise/editAdvertise',
                success: function(data) {
                    var obj = $.parseJSON(data);
                    if (obj.errCode == -1) {
                        $('.id').val(id);
        ...
        $('#update').submit(function(e) {
            ...
            $.ajax({
                ...
                processData: false,
                contentType: false,
                url: base_url + 'Advertise/updateAdvertise',
                success: function(data) {
                    var obj = $.parseJSON(data);
                    if (obj.errCode == -1) {
                        alert(obj.message);
