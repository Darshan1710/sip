            ...
            <div class="col-md-12">
              <div class="panel panel-flat">
                ...
                <div class="panel-body">
                  ...
                  <input type="hidden"  value="<?php echo $order['customer_unique_id']; ?>" name="customer_unique_id">
                  ...
                  <div class="row clone-div">
                    ...
                    <div class="col-md-2">
                      <div class="form-group">
                          ...
                          <input type="text" class="form-control" placeholder="Sell Price" name="sell_price[]" value="<?php echo set_value('id',isset($row['sell_price']) ? $row['sell_price'] : '')?>" readonly id="sell_price_<?php echo $i; ?>" data-count="<?php echo $i ?>">
                    ...
                    <div class="col-md-3">
                      <div class="form-group">
                          <label>Price:</label>
                          <input type="text" class="form-control price_<?php echo $i; ?>" placeholder="Price" name="price[]" value="<?php echo set_value('id',isset($row['price']) ? $row['price'] : '0')?>" id="price_<?php echo $i; ?>" data-count="<?php echo $i ?>" readonly>
                  ...
                  <div class=" col-md-4">
                    <div class="form-group">
                    <input type="text"  readonly="" class="form-control" id="subtotal" value="<?php echo set_value('subtotal',isset($order['subtotal']) ? $order['subtotal'] : '')?>">
                    </div>
                  </div>
                  </div>
                  <div class="row">
                  ...
                  <select class="select form-control discount_type" name="discount_type"  data-count="<?php echo $i ?>">
                      ...
                      <option value="1" <?php echo set_select('discount_type', '1', $order['discount_type'] == '1' ? TRUE : FALSE ); ?>>Percentage</option>
                      <option value="2" <?php echo set_select('discount_type', '2', $order['discount_type'] == '2' ? TRUE : FALSE ); ?>>Normal</option>
                    </select>
                  </div>
                  <div class=" col-md-2">
                    <div class="form-group">
                      <label>Discount</label>
                    <input type="number" class="form-control discount" id="discount" name="discount" value="<?php echo set_value('discount',isset($order['discount']) ? $order['discount'] : '0')?>">
                    </div>
                  </div>
                  ...
                  <div class=" col-md-4">
                    ...
                    <input type="number" class="form-control" id="final_discount" step="0.01" value="<?php echo set_value('final_discount',isset($order['final_discount']) ? $order['final_discount'] : '0')?>" readonly>
                    </div>
                  </div>
                  </div>
                  <div class="row">
                  ...
                  <div class=" col-md-4">
                    <div class="form-group">
                    <input type="number"  name="delivery_charge" class="form-control" id="delivery_charge" value="<?php echo set_value('delivery_charge',isset($order['delivery_charge']) ? $order['delivery_charge'] : '0')?>">
                    </div>
                  </div>
                  </div>
                  <div class="row">
                  ...
                  <div class=" col-md-4">
                    <div class="form-group">
                    <input type="text"  readonly="" class="form-control" id="final_total" value="<?php echo set_value('final_total',isset($order['final_total']) ? $order['final_total'] : '')?>">
                    </div>
                  </div>
                  </div>
...
<script type="text/javascript">
      ...
      $(document).on('focusout','.qty',function(){
            ...
            var offline_price = $('#sell_price_'+count).val();
            ...
            final_total = subtotal + parseInt(delivery_charge);
        ...
        function updateDiscount(){
              ...
              if(discount_type == '1'){
                final_discount = ((discount / 100) * subtotal);
              }else{
        ...
        $(document).on('focusout','.discount',function(){
              ...
              if(discount_type){
                  ...
                  var delivery_charge = $('#delivery_charge').val();
                  // console.log(subtotal+' '+final_discount+' '+delivery_charge);
                  var final_total = (parseFloat(subtotal) + parseFloat(delivery_charge) - parseFloat(final_discount));
            ...
            $.ajax({
                ...
                success:function(data){
                    ...
                    if(obj.errCode == -1){
                        ...
                        $('#final_total').val(obj.final_total.toFixed(2));
                    }else{
       ...
       $('#addOrder').submit(function(e) {
        ...
        $('#address_form').submit(function(e) {
            ...
            $.ajax({
                ...
                processData: false,
                contentType: false,
                url: base_url + 'Customer/addOrderCustomerAddress',
                success: function(data) {
                    var obj = $.parseJSON(data);
                    if (obj.errCode == -1) {
                        window.location.reload();
        ...
        $('#editcustomerform').submit(function(e) {
            ...
            $.ajax({
                type: 'post',
                data: form_data,
                url: base_url + 'Customer/editOrderCustomer',
                processData: false,
                contentType: false,
                success: function(data) {
                    var obj = $.parseJSON(data);
